...
HD_PWD='C:/Users/Lab/PL_PS_NANDgate/PL_PS_NANDgate.runs/design_1_nand_gate_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_nand_gate_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_nand_gate_0_0.tcl
